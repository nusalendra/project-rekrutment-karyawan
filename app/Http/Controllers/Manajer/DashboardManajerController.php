...
class DashboardManajerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages/dashboard/dashboard-manajer', ['title' => 'Dashboard'], compact('currentYear', 'chartDataPelamarTahunIni', 'pelamarPekerjaan', 'pelamarLolosSeleksi', 'pelamarTesPotensiAkademik', 'pelamarLolosTesPotensiAkademik', 'pelamarTesWawancara', 'pelamarLolosTesWawancara'));
    }
