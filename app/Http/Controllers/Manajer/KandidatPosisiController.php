...
class KandidatPosisiController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.manajer.kandidat-posisi.index', ['title' => 'Kandidat Posisi'], compact('data', 'pelamar', 'searchTerm'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.manajer.kandidat-posisi.show', ['title' => 'Data Kandidat'], compact('data', 'lowonganPekerjaanIdDecrypt'));
    }
    ...
    public function edit($pelamarId, $lowonganPekerjaanId)
    {
        ...
        return view('pages.manajer.kandidat-posisi.edit', ['title' => 'Detail Kandidat'], compact('data', 'pelamarId', 'lowonganPekerjaanId', 'dataUser'));
    }

    public function downloadDokumenKandidat($dokumenName, $fileName)
    {
