                        ...
                        <div class="col-span-1 space-y-0.5 font-semibold">
                            ...
                            <div class="flex w-full h-16">
                                ...
                                <div class="flex items-center pl-3 mt-2">
                                    <a href="{{ route('unduh-dokumen-pelamar-disetujui', ['dokumenName' => basename($dataUser->user->name), 'fileName' => $dataUser->surat_lamaran_kerja]) }}"
                            ...
                            <div class="flex w-full h-16">
                                ...
                                <div class="flex items-center pl-3 mt-2">
                                    <a href="{{ route('unduh-dokumen-pelamar-disetujui', ['dokumenName' => basename($dataUser->user->name), 'fileName' => $dataUser->curriculum_vitae]) }}"
                                        class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                            fill="currentColor" class="bi bi-cloud-arrow-down-fill text-white"
                                            viewBox="0 0 17 17">
                            ...
                            <div class="flex w-full h-16">
                                ...
                                <div class="flex items-center pl-3 mt-2">
                                    <a href="{{ route('unduh-dokumen-pelamar-disetujui', ['dokumenName' => basename($dataUser->user->name), 'fileName' => $dataUser->ijazah]) }}"
                                        class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                            fill="currentColor" class="bi bi-cloud-arrow-down-fill text-white"
                                            viewBox="0 0 17 17">
