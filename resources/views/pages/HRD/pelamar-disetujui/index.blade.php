                    ...
                    <table class="w-full text-base text-left text-black dark:text-gray-400">
                        <thead
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <h1 class="flex w-full justify-center">Tanggal Lamaran Disetujui</h1>
                                </th>
                                <th scope="col" class="px-6 py-3">
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <h1 class="flex w-full justify-center">
                                            {{ \Carbon\Carbon::parse($item->hasilValidasi->created_at)->format('d-m-Y, H:i:s') }}
                                        </h1>
                                    </td>
                                    <td class="px-6 py-4">
                                        <h1 class="flex w-full justify-center">
                                            ...
                                            @endphp
                                            {{-- Edit --}}
                                            <a href="/pelamar-disetujui/detail/{{ $pelamarIdEncrypt }}"
