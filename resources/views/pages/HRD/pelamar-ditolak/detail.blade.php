        ...
        <div class="container mx-auto p-4">
            ...
            <div class="mt-3">
                ...
                <div class="bg-white p-4 rounded shadow">
                    ...
                    <button
                        class="text-white bg-red-500 hover:bg-red-600 border border-red-500 focus:outline-none focus:ring-white-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">Lamaran {{ $data->status_lamaran }}</button>
                </div>
            </div>
        </div>
    </div>
