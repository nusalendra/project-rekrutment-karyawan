        ...
        <div class="bg-stone-200 bg-auto rounded h-216">
            <div class="px-12 pt-5 text-black">
                <div class="flex justify-between items-center mb-5">
                    <h2 class="flex h-full font-bold text-gray-700 items-center drop-shadow-md text-xl ">Data Pelamar Ditolak
                    </h2>
                </div>
                <div class="flex mb-4">
                    <a href="/pelamar-ditolak"
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <h1 class="flex w-full justify-center">
                                            ...
                                            {{-- Edit --}}
                                            <a href="{{ route('pelamar-ditolak-detail', ['pelamarId' => $pelamarIdEncrypt, 'lowonganPekerjaanId' => $lowonganPekerjaanIdEncrypt]) }}"
