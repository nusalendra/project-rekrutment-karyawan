...
@section('content')
        ...
        <div class="bg-stone-200 bg-auto rounded h-216">
            <div class="px-12 pt-9 text-black">
                <div class="flex justify-between items-center mb-3">
                    <h2 class="flex h-full font-bold text-gray-700 items-center drop-shadow-md text-xl ">Periode
                    </h2>
                            ...
                            @if (count($data) == 0)
                                <tr
                                    ...
                                    <td class="px-6 py-4" colspan="7">
                                        <h1 class="flex w-full justify-center">Tidak Ada Data Periode</h1>
                                    </td>
                                </tr>
                            @else
    ...
    <script>
        ...
        const loadData = async (searchTerm, page) => {
            try {
                const response = await fetch(`/periode?search=${searchTerm}&page=${page}`);
