    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="content bg-white bg-auto h-216 mt-2 rounded">
            <div class="px-11 py-9 text-black">
                ...
                <form action="/tes-potensi-akademik/create" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <div class="w-1/2 mx-3 mt-5">
                            <div class="relative w-full">
                                ...
                                <input required type="text" id="nama" name="nama" placeholder="Masukkan Nama TPA"
