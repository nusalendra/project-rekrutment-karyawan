...
@section('content')
        ...
        <div class="bg-stone-200 bg-auto rounded h-216">
            <div class="px-12 pt-9 text-black">
                <div class="flex justify-between items-center mb-3">
                    <h2 class="flex h-full font-bold text-gray-700 items-center drop-shadow-md text-xl ">Tes Potensi Akademik
                    </h2>
                    <div class="flex space-x-6 items-center">
                        <a href="/tes-potensi-akademik/create"
                    ...
                    <table class="w-full text-base text-left text-black dark:text-gray-400">
                        <thead
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <h1 class="flex w-full justify-center">Nama Tes</h1>
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    <h1 class="flex w-full justify-center">Untuk Jabatan</h1>
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    <h1 class="flex w-full justify-center">Tanggal & Waktu Mulai</h1>
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    <h1 class="flex w-full justify-center">Tanggal & Waktu Selesai</h1>
                                </th>
                                <th scope="col" class="px-6 py-3">
                            ...
                            @if (count($data) == 0)
                                <tr
                                    ...
                                    <td class="px-6 py-4" colspan="7">
                                        <h1 class="flex w-full justify-center">Tidak Ada Data Tes Potensi Akademik</h1>
                                    </td>
                                </tr>
                            @else
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <h1 class="flex w-full justify-center">
                                                {{ $item->nama_tes_potensi_akademik }}</h1>
                                        </td>
                                        <td class="px-6 py-4">
                                            <h1 class="flex w-full justify-center">
                                                {{ $item->nama_jabatan }}</h1>
                                        </td>
                                        <td class="px-6 py-4">
                                            <h1 class="flex w-full justify-center">
                                                {{ \Carbon\Carbon::parse($item->tanggal_waktu_mulai)->format('d-m-Y / H:i') }}
                                        </td>
                                        <td class="px-6 py-4">
                                            <h1 class="flex w-full justify-center">
                                                {{ \Carbon\Carbon::parse($item->tanggal_waktu_selesai)->format('d-m-Y / H:i') }}
                                            </h1>
                                        </td>
                                        <td class="px-6 py-4">
                                            <h1 class="flex w-full justify-center">
                                                ...
                                                <a href="/tes-potensi-akademik/pertanyaan/{{ $tesPotensiAkademikId }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="currentColor" class="bi bi-list-columns my-2"
                                                        viewBox="0 0 16 16">
                                                ...
                                                {{-- Edit --}}
                                                <a href="/tes-potensi-akademik/edit/{{ $tesPotensiAkademikId }}"
                                                    class="{{ $title === 'Edit Data' }} text-black mr-1 flex bg-yellow-300 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-sm sm:w-auto px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                {{-- Delete --}}
                                                <a href="/tes-potensi-akademik/delete/{{ $item->id }}"
    ...
    <script>
        ...
        const loadData = async (searchTerm, page) => {
            try {
                const response = await fetch(`/tes-potensi-akademik?search=${searchTerm}&page=${page}`);
