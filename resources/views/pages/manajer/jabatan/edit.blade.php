                    ...
                    <div class="flex mb-1">
                        ...
                        <div class="w-1/2 mx-3">
                            <label for="gaji_awal"
                                class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Gaji Awal <span
                                    class="text-red-700">*</span></label>
                            <input required type="text" id="gaji_awal" name="gaji_awal" value="{{ $jabatan->gaji_awal }}"
                                title="Tidak diperbolehkan menggunakan karakter khusus"
                        ...
                        <div class="w-1/2 mx-3">
                            ...
                            <input required type="text" id="gaji_akhir" name="gaji_akhir"
                                value="{{ $jabatan->gaji_akhir }}" title="Tidak diperbolehkan menggunakan karakter khusus"
                        ...
                        <div class="w-full mx-3">
                            <label for="deskripsi"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi Jabatan <span
                                    class="text-red-700">*</span></label>
                            <textarea class="form-control" id="deskripsi" name="deskripsi">{!! $jabatan->deskripsi !!}</textarea>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div class="w-full mx-3">
                            <label for="benefit_pekerjaan"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Benefit Pekerjaan <span
                                    class="text-red-700">*</span></label>
                            <textarea class="form-control" id="benefit_pekerjaan" name="benefit_pekerjaan">{!! $jabatan->benefit_pekerjaan !!}</textarea>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div class="w-full mx-3">
                            <label for="kriteria"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kriteria <span
                                    class="text-red-700">*</span></label>
                            <textarea class="form-control" id="kriteria" name="kriteria">{!! $jabatan->kriteria !!}</textarea>
                        </div>
                    </div>
