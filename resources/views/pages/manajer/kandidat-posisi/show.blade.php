        ...
        <div class="bg-stone-200 bg-auto rounded h-216">
            ...
            <div class="px-12 pt-5 text-black">
                <div class="flex items-center mb-8">
                    ...
                    <h2 class="flex h-full font-bold text-gray-700 items-center drop-shadow-md text-xl ">Data Kandidat Terpilih</h2>
                </div>
                            ...
                            @if (count($data) == 0)
                                <tr
                                    ...
                                    <td class="px-6 py-4" colspan="7">
                                        <h1 class="flex w-full justify-center">Tidak Ada Data Kandidat Terpilih</h1>
                                    </td>
                                </tr>
                            @else
