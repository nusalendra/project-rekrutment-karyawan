...
@section('content')
            ...
            <div class="px-12 pt-9 text-black">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <div class="flex space-x-6 items-center">
                        <a href="/kriteria-screening/create"
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <h1 class="flex w-full justify-center">
                                            ...
                                            @endphp
                                            {{-- Edit --}}
                                            <a href="/kriteria-screening/edit/{{ $kriteriaId }}"
                                            ...
                                            {{-- Delete --}}
                                            <a href="/kriteria-screening/delete/{{ $item->id }}"
    ...
    <script>
        ...
        const loadData = async (searchTerm, page) => {
            try {
                const response = await fetch(`/kriteria-screening?search=${searchTerm}&page=${page}`);
