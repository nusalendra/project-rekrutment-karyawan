...
@section('content')
                            ...
                            @if (count($data) == 0)
                                <tr
                                    ...
                                    <td class="px-6 py-4" colspan="7">
                                        <h1 class="flex w-full justify-center">Data Pengukuran Kosong</h1>
                                    </td>
                                </tr>
                            @else
                                @foreach ($data as $index => $item)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <h1 class="flex w-full justify-center">{{ $item->nama_pengukuran }}</h1>
                                        </td>
                                        <td class="px-6 py-4">
    ...
    <script>
        ...
        const loadData = async (searchTerm, page) => {
            try {
                const response = await fetch(`/pengukuran?search=${searchTerm}&page=${page}`);
