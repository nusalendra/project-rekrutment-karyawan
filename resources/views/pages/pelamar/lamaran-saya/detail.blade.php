                    ...
                    <div class="col-span-1 space-y-0.5 font-semibold">
                        ...
                        <div class="flex w-full h-16">
                            ...
                            <div class="flex items-center pl-3 mt-2">
                                <a href="{{ route('unduh-dokumen-peserta', ['dokumenName' => basename($data->user->name), 'fileName' => $data->user->curriculum_vitae]) }}"
                        ...
                        <div class="flex w-full h-16">
                            <label for="pas_foto" class="flex w-1/3 pl-3 text-gray-600 bg-blue-50 items-center">Pas
                                Foto</label>
                            <div class="flex items-center pl-3 mt-2">
                                <a href="{{ route('unduh-dokumen-peserta', ['dokumenName' => basename($data->user->name), 'fileName' => $data->user->pas_foto]) }}"
                                    class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                        fill="currentColor" class="bi bi-cloud-arrow-down-fill text-white"
                                        viewBox="0 0 17 17">
                        ...
                        <div class="flex w-full h-16">
                            <label for="ijazah_transkrip"
                                ...
                                Nilai</label>
                            <div class="flex items-center pl-3 mt-2">
                                <a href="{{ route('unduh-dokumen-peserta', ['dokumenName' => basename($data->user->name), 'fileName' => $data->user->ijazah_transkrip]) }}"
                                    class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                        fill="currentColor" class="bi bi-cloud-arrow-down-fill text-white"
                                        viewBox="0 0 17 17">
                        ...
                        <div class="flex w-full h-16">
                            <label for="surat_lamaran_kerja" class="flex w-1/3 pl-3 text-gray-600 bg-blue-50 items-center">Surat
                                Lamaran Kerja</label>
                            <div class="flex items-center pl-3 mt-2">
                                <a href="{{ route('unduh-dokumen-peserta', ['dokumenName' => basename($data->user->name), 'fileName' => $data->user->surat_lamaran_kerja]) }}"
                                    class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                        fill="currentColor" class="bi bi-cloud-arrow-down-fill text-white"
                                        viewBox="0 0 17 17">
                                    ...
                                    @foreach ($dataDokumenPendukung as $dokumenPendukung)
                                        @if ($dokumenPendukung->subkriteria_id == $item->subkriteria->id)
                                            @if (!$unduhDokumenTampil)
                                                <div class="flex items-center pl-3 mt-2">
                                                    <a href="{{ route('unduh-dokumen-lamaran', ['fileName' => basename($dokumenPendukung->dokumen), 'pelamarName' => $data->user->name]) }}"
                                                        class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
