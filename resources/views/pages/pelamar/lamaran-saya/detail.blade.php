            ...
            <div class="px-11 py-9 text-black">
                ...
                <form action="{{ route('proses-seleksi-update', ['lowonganPekerjaanId' => $lowonganPekerjaanId]) }}"
                                    ...
                                    <div class="flex w-full h-16">
                                        <div class="flex items-center mt-2">
                                            @isset($dataUser->surat_lamaran_kerja)
                                                <a href="{{ route('unduh-dokumen-peserta', ['dokumenName' => basename($dataUser->user->name), 'fileName' => $dataUser->surat_lamaran_kerja]) }}"
                                    ...
                                    <div class="flex w-full h-16">
                                        <div class="flex items-center  mt-2">
                                            @isset($dataUser->curriculum_vitae)
                                                <a href="{{ route('unduh-dokumen-peserta', ['dokumenName' => basename($dataUser->user->name), 'fileName' => $dataUser->curriculum_vitae]) }}"
                                                    class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                                        fill="currentColor" class="bi bi-cloud-arrow-down-fill text-white"
                                                        viewBox="0 0 17 17">
                                    ...
                                    <div class="flex w-full h-16">
                                        <div class="flex items-center  mt-2">
                                            @isset($dataUser->ijazah)
                                                <a href="{{ route('unduh-dokumen-peserta', ['dokumenName' => basename($dataUser->user->name), 'fileName' => $dataUser->ijazah]) }}"
                                                    class="flex justify-center items-center bg-blue-500 h-10 px-3 py-1 space-x-1 rounded-lg hover:bg-blue-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                                        fill="currentColor" class="bi bi-cloud-arrow-down-fill text-white"
                                                        viewBox="0 0 17 17">
                    ...
                    <div class="pt-6 flex justify-start">
                        <a href="/lamaran-saya"
                            class="mr-3 bg-yellow-500 hover:bg-yellow-600 border border-yellow-500 focus:outline-none focus:ring-white-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                            Kembali
                        </a>
                    </div>
                </form>
