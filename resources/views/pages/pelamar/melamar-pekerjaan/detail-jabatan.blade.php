<div class="text-black">
    ...
    <div class="mr-2 mb-2 ml-3 mt-3 py-3">
        ...
        @elseif($statusLamaran == 'Divalidasi')
            <button type="button"
        ...
        @elseif($tanggalSekarang >= $lowonganPekerjaan->tanggal_akhir)
            <button type="button"
                class="focus:outline-none text-white bg-red-800 hover:bg-red-900 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
                @disabled(true)>Tanggal Pendaftaran Telah Kedaluwaraa</button>
        @else
            @php
