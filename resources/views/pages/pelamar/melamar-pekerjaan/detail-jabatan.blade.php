<div class="text-black">
    ...
    <div class="mr-2 mb-2 ml-3 mt-3 py-3">
        @if ($statusLamaran == 'Proses')
            <button type="button"
                class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" @disabled(true)>Lamaran di Proses</button>
        @else
            <a href="/lamar/{{ $lowonganPekerjaan->jabatan->id }}"
